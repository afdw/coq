...
struct
  ...
  let make f =
    ...
    );
    {
      ...
      full_path = run_full_path (fun () -> simple_string_of_ppcmds (f ()));
      no_notations = run_no_notations (fun () -> simple_string_of_ppcmds (f ()));
      low_level = run_low_level (fun () -> simple_string_of_ppcmds (f ()));
