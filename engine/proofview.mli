...
module Trace : sig
  (** [with_recording true t] behaves like [t] and computes its Info trace.
      [with_recording false t] behaves like [t], but does not compute its Info trace. *)
  val with_recording : bool -> 'a tactic -> 'a tactic
