...
(** Build the config/coq_config_bin.ml file *)
let write_coq_config_bin_ml caml_version_nums o =
  let pr s = fprintf o s in
...
let main () =
  ...
  write_config_file ~file:"config/coq_config_bin.ml" (write_coq_config_bin_ml caml_version_nums);
