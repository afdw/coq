...
type patvar_map = EConstr.constr Id.ObservableMap.t
type extended_patvar_map = constr_under_binders Id.ObservableMap.t
...
type closure = {
  idents:Id.t Id.ObservableMap.t;
  typed: constr_under_binders Id.ObservableMap.t ;
  untyped:closed_glob_constr Id.ObservableMap.t;
  genargs : Geninterp.Val.t Id.ObservableMap.t; }
and closed_glob_constr = {
  closure: closure;
  term: glob_constr }

(** Ltac variable maps *)
type var_map = constr_under_binders Id.ObservableMap.t
type uconstr_var_map = closed_glob_constr Id.ObservableMap.t
type unbound_ltac_var_map = Geninterp.Val.t Id.ObservableMap.t
...
type ltac_var_map = {
  ...
  ltac_idents: Id.t Id.ObservableMap.t;
